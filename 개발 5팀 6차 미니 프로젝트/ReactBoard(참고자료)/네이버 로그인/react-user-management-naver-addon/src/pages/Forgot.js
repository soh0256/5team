...
const Forgot = () => { 
    ...
    const findId = (e) => {
        fetch("http://localhost:3001/api/findid", {
            headers: {
    ...
    const findPw = (e) => {
        fetch("http://localhost:3001/api/findpw", {
            headers: {
                "Content-Type": "application/json",
                Accept: "application/json"
            },
    ...
    const ifRender = () => {
        if(value === "selectId") {
            return(
                <Fragment>
                    <div className="column">
                        <p className="selectText">아이디는 문자로 발송됩니다.</p>
                    </div>
                    ...
                    <div className="column">
                        <Button label="찾기" raised className="findIdButton" onClick={findId}/>
                    </div>
                </Fragment>
            )
        }else {
            return(
                <Fragment>
                    <div className="column">
                        <p className="selectText">비밀번호는 문자로 발송됩니다.</p>
                    </div>
                    ...
                    <div className="column">
                        <Button label="찾기" raised className="findPwButton" onClick={findPw}/>
                    </div>
                </Fragment>
            )
        }
